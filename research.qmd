...
### Adult angular gyrus supports inference through direct retrieval of indirect associations

Modeling of response-time measures and fMRI data reveals that angular gyrus activation predicts a direct retrieval process in adults but not children [@2026_Coughlin].

![](ref/abstracts/2026_Coughlin.png)
