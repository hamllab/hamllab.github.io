...
See the UWM Psychology PHD program website for [instructions on applying](https://uwm.edu/psychology/graduate/application/). Application materials are due on December 1. If you're planning to apply, it's a good idea to email Dr. Morton first to introduce yourself and say a bit about why you want to work in the lab. It is also helpful to attach a [curriculum vitae](https://www.prospectivedoctor.com/how-to-write-an-undergraduate-cv/) if you have one. Dr. Morton can answer any questions you have about the program and research in the lab.
